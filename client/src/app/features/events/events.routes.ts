...
import { EventSeriesEditComponent } from './event-series-edit/event-series-edit.component';
...
export const EVENTS_ROUTES: Routes = [
  ...
  { path: 'series/:seriesId/edit', component: EventSeriesEditComponent, canActivate: [authGuard, coordinatorGuard] },
